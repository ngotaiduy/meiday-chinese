...
function renderHome() {
  ...
  let gc2 =
    ...
    ' điểm ngữ pháp</div><div class="lesson-title-vi">Lý thuyết + Ví dụ theo bài</div></div>';
  return (
    '<div class="home-hero fade-in"><h1>新HSK教程</h1><p>Ôn tập từ vựng HSK 3.0 theo giáo trình chính thức. Lật thẻ, làm quiz, học mỗi ngày!</p><div class="stats-row"><div class="stat"><div class="stat-num">9</div><div class="stat-label">Cấp độ</div></div><div class="stat"><div class="stat-num">11000</div><div class="stat-label">Từ vựng</div></div><div class="stat"><div class="stat-num">4</div><div class="stat-label">Chế độ ôn</div></div></div></div><div style="margin:40px auto 20px;max-width:600px;background:linear-gradient(135deg,#FFF5F5,#FFF0E6);border:2px solid #E8D5C4;border-radius:16px;padding:24px 28px;text-align:center"><div style="font-size:14px;color:#C0392B;font-weight:700;margin-bottom:8px">📚 Giáo viên biên soạn</div><div style="font-size:18px;font-weight:700;color:var(--ink);margin-bottom:6px">Cô Trần Mỹ Hạnh</div><div style="font-size:13px;color:var(--ink-light);line-height:1.7;margin-bottom:12px">Thạc sĩ tại Trung Quốc · HSK7 · HSK6 3.0 285đ · TOCFL C1</div><a href="https://zalo.me/0857042098" target="_blank" style="display:inline-block;padding:10px 24px;background:#0068FF;color:white;border-radius:10px;text-decoration:none;font-weight:600;font-size:14px">💬 Liên hệ học HSK 3.0 qua Zalo: 0857042098</a></div><div class="section-title"><span class="badge badge-hsk1">HSK 1</span> 新HSK教程 1 <span style="font-size:13px;color:var(--ink-light);font-family:Be Vietnam Pro;font-weight:400">· ' +
    hsk1Total +
